...
gracecommand = "gracebat " + model + "/pRB.txt " + model + "/pRBc1.txt " + model + "/pRBp.txt " + model + "/pRBc2.txt " + model + "/pRBpp.txt -param prb-params.agr -printfile temp.ps"
subprocess.call(gracecommand.split())
subprocess.call(("convert -rotate 90 temp.ps " + model + "_prb.png").split())
subprocess.call("rm temp.ps".split())
image = model + "_prb.png"
